...
const { DoctorRegister, fetchAppointments, addPrescription, viewPrescription, viewLoggedDoctor, changeAvalibility, doctorProfileEdit, createSchedule } = require('../controller/doctorControl')
...
RouterDoctor.put('/changeavailability', verifyToken, authorizeRole('doctor'), changeAvalibility)
